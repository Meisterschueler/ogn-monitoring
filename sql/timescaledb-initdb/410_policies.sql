...
SELECT add_compression_policy('sender_position_states_15m', compress_after => INTERVAL '4 hours');
...
SELECT add_compression_policy('sender_position_states_1d', compress_after => INTERVAL '16 days');
...
SELECT add_compression_policy('receiver_position_states_15m', compress_after => INTERVAL '4 hours');
...
SELECT add_compression_policy('receiver_position_states_1d', compress_after => INTERVAL '16 days');
...
SELECT add_compression_policy('receiver_status_states_15m', compress_after => INTERVAL '4 hours');
...
SELECT add_compression_policy('receiver_status_states_1d', compress_after => INTERVAL '16 days');
...
SELECT add_compression_policy('sender_position_statistics_15m', compress_after => INTERVAL '4 hours');
...
SELECT add_compression_policy('sender_position_statistics_1d', compress_after => INTERVAL '16 days');
...
SELECT add_compression_policy('sender_statistics_15m', compress_after => INTERVAL '4 hours');
...
SELECT add_compression_policy('sender_statistics_1d', compress_after => INTERVAL '16 days');
...
SELECT add_compression_policy('receiver_statistics_15m', compress_after => INTERVAL '4 hours');
...
SELECT add_compression_policy('receiver_statistics_1d', compress_after => INTERVAL '16 days');
