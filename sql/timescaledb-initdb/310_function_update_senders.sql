...
BEGIN
	...
	INSERT INTO senders AS s (name, original_address, last_position, location, altitude, address_type, aircraft_type, is_stealth, is_notrack, address, software_version, hardware_version, messages)
	SELECT
		src_call AS name,
		original_address,
	...
	SET
		...
		messages = s.messages + EXCLUDED.messages;
