...
BEGIN
	...
	INSERT INTO senders AS s (name, last_position, location, altitude, address_type, aircraft_type, is_stealth, is_notrack, address, software_version, hardware_version, original_address)
	SELECT
		src_call AS name,
	...
	SET
		...
		original_address = CASE EXCLUDED.original_address IS NOT NULL WHEN TRUE THEN EXCLUDED.original_address ELSE s.original_address END;
